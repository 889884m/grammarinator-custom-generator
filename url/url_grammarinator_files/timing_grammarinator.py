...
input_sizes = list(range(2, 10000, 1000))

command = "grammarinator-generate urlGenerator.urlGenerator --sys-path /Users/brooke_s/grammarinator-custom-generator/URL/url_grammarinator_files -r url -d 20 -n "
